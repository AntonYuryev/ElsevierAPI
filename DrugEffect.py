...
INCLUDE_CHILDREN = True # if substance has ontology children to consider
NOT_INCLUDE_CHILDREN = False
...
class RepurposeDrug(TargetIndications):
    ...
    def set_drug(self, drug_name:str, similar_drugs:list, include_children=True, mode=INHIBIT, indication_types=None, type=ANTAGONIST):
    ...
    def find_indications4similars(self):
        ...
        SimilarDrugsIndications = self.process_oql(OQLquery.format(eff=effect,select_drugs=select_similar_drugs,indication_types=self.indication_types), REQUEST_NAME)
...
if __name__ == "__main__":
    ...
    similars = [] # list of names of similar drugs that have the same mechanism of action
