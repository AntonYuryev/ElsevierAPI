...
class RepurposeDrug(TargetIndications):
    ...
    def score_drug_semantics(self):
        ...
        linked_entities_count,linked_entities = self.link2concept(colname, self.drug_ids)
        ...
        if hasattr(self,'similar_drug_ids'):
            ...
            linked_entities_count,linked_entities = self.link2concept(colname, self.similar_drug_ids)
    ...
    def add_drug_indication_refs(self):
        ...
        ct_pd = self.snippets2df(clin_trial_graph)
        ...
        research_ref_pd = self.snippets2df(research_graph)
