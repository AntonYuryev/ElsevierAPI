...
ps_api.PageSize = 50
all_completed_trials = ps_api.process_oql('SELECT Relation WHERE objectType = ClinicalTrial AND TrialStatus = Completed AND NeighborOf (SELECT Entity WHERE objectType = SmallMol) AND RelationNumberOfReferences = 1',debug=True)
